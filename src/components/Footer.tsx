...
export function Footer({ openPage }: { openPage: (p: Page) => void }) {
  const socialLinks = [
    { icon: <Instagram size={20} />, href: "https://instagram.com/hoorain_perfumes_" },
    { icon: <Facebook size={20} />, href: "https://www.facebook.com/share/1CEzZTygTP/" },
    ...
    <footer className="bg-black border-t border-gold/20 pt-16 pb-8">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            <h3 className="text-lg font-semibold text-gold tracking-wider">Quick Links</h3>
          ...
          <div>
            <h3 className="text-lg font-semibold text-gold tracking-wider">Contact Us</h3>
            <ul className="mt-4 space-y-3 text-ivory/80">
              <li>info@hoorainperfumes.com</li>
              <li>+91 12345 67890</li>
              <li>Jamkhandi, Karnataka, India</li>
            </ul>
          </div>

          <div className="md:col-span-1">
            <h3 className="text-lg font-semibold text-gold tracking-wider">Our Location</h3>
        ...
        <div className="mt-12 border-t border-gold/20 pt-8 text-center text-ivory/60">
          <p>&copy; {new Date().getFullYear()} Hoorain Perfumes. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  );
